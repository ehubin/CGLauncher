...
class Player {
  ...
  static class State {
    ...
    /**
     * Every turn: You must affect 5 units to planets you can reach. You can
     * reach planets you already have at least one unit on and the neighbors of
     * planets you control. You may choose to sacrifice 5 units from a planet
     * you control in order to spawn 1 unit on each of that planet's neighbors,
     * regardless of the amount of neighbors. This is called unit spread.
     * 
     * @param a
     * @param player
     * @return
